...
async function GET(_, { params }) {
    try {
        const video = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getVideo"])(params.id);
...
async function DELETE(_, { params }) {
    try {
        const video = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteVideo"])(params.id);
        if (!video) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Not found"
        }, {
            status: 404
        ...
        if (video.trimmedUrl.startsWith('/uploads/')) {
            const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', video.trimmedUrl);
            try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__53759848._.js.map