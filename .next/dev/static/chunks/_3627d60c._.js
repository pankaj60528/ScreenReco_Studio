...
function WatchPage() {
    ...
    const [completionReported, setCompletionReported] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WatchPage.useEffect": ()=>{
            const load = {
                "WatchPage.useEffect.load": async ()=>{
                    if (!params?.id) return;
                    try {
                        ...
                        for(let attempt = 0; attempt < 3; attempt++){
                            ...
                            if (res.status >= 500 && attempt < 2) {
                                await new Promise({
                                    "WatchPage.useEffect.load": (r)=>setTimeout(r, 500 * (attempt + 1))
                                }["WatchPage.useEffect.load"]);
                                continue;
                            }
                            if (res.status === 404) {
                                try {
                                    ...
                                    if (listRes.ok) {
                                        ...
                                        const found = (listData.videos || []).find({
                                            "WatchPage.useEffect.load.found": (v)=>v.id === params.id || v.shareId === params.id
                                        }["WatchPage.useEffect.load.found"]);
                                        if (found) {
                                            setVideo(found);
...
_s(WatchPage, "e0oP+4T0rbbrsG2HbrME76JpvSs=", false, function() {
    return [
...
//# sourceMappingURL=_3627d60c._.js.map